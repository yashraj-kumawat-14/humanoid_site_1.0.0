...
class Speak(Node):
	def __init__(self):
		...
		model_path = "/home/yantrigo/Dropbox/humanoid_site_1.0.0/software/firmware/rpi5/humanoid/src/mouth/mouth/piper_models/english_models/male/ryan/en_US-ryan-low.onnx"# By the way choose default one from settings.json
